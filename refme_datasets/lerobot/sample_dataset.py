...
if __name__ == '__main__':
    ...
    # print(sample_target)
    # sample_target = list(range(1200, 1800)) # list(range(2160, 2760))
    #sample_target = list(range(600, 1200))
    sample_target = list(range(0, 120))

    target_dir = '/data/piper_multitask_push'

    data_dir = '/data/piper_open_the_pot/lerobot_5hz'
    ...
    data_dir = '/data/piper_pickplace/lerobot_5hz'
    os.makedirs(target_dir, exist_ok=True)
    os.makedirs(os.path.join(target_dir, 'data'), exist_ok=True)
    os.makedirs(os.path.join(target_dir, 'meta'), exist_ok=True)
    os.makedirs(os.path.join(target_dir, 'videos'), exist_ok=True)
    sample_dataset(sample_target, data_dir, target_dir, 120)

    data_dir = '/data/piper_push/lerobot_5hz'
    os.makedirs(target_dir, exist_ok=True)
    os.makedirs(os.path.join(target_dir, 'data'), exist_ok=True)
    os.makedirs(os.path.join(target_dir, 'meta'), exist_ok=True)
    os.makedirs(os.path.join(target_dir, 'videos'), exist_ok=True)

    sample_dataset(sample_target, data_dir, target_dir, 240)
