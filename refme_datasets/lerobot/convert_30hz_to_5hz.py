...
def convert_30hz_to_5hz(source_base_path, dest_base_path, index):
    # 반복되는 이름들을 변수로 선언
...
if __name__ == "__main__":
    for i in tqdm(range(0,60)):
        convert_30hz_to_5hz("/data/piper_press_the_blue_button_ep60/lerobot", "/data/piper_press_the_blue_button_ep60/lerobot_5hz", i)
