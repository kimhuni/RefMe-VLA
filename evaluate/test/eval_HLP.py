...
CUDA_VISIBLE_DEVICES=0 python evaluate/eval_HLP.py \
    ...
    --adapter_path /result/ghkim/HLP_qwen_2.5_7b_QLoRA_r16_press_the_blue_button_ep60_1111/checkpoint-1000 \
    --dataset_file /data/ghkim/piper_press_the_blue_button_ep60/gpt-5-mini/eval_final/shards/chunk-000.jsonl \
    --output_file /data/ghkim/piper_press_the_blue_button_ep60/eval_qwen_QLoRA_1111_1k/shards/chunk_000_evaluation.jsonl \
    --is_qlora True
