...
torch_device = "cuda"
model_checkpoint = "/ckpt/llava-onevision-7b-hf"
...
output_dir = "/result/VLM_test/piper_press_the_blue_button_screenshot/llava"
...
# Save and notify
save_path = os.path.join(output_dir, os.path.basename(IMAGE_PATH).replace(".jpg", "_llava.jpg"))
