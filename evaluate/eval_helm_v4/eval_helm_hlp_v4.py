...
"""
CUDA_VISIBLE_DEVICES=4 python evaluate/eval_helm_v4/eval_helm_hlp_v4.py \
  ...
  --out_jsonl /data/ghkim/helm_data/result/HLP_HeLM_v4_qwen_7b_all_0115/eval_step_3000.jsonl
