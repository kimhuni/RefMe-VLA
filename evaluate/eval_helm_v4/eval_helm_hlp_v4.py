...
CUDA_VISIBLE_DEVICES=5 python evaluate/eval_helm_v4/eval_helm_hlp_v4.py \
  ...
  --adapter /result/ghkim/HeLM_v4/HLP_HeLM_v4_qwen_7b_all_0113/checkpoint-3000 \
  --max_samples 200 --seed 123 \
  --out_jsonl /data/ghkim/helm_data/result/HLP_HeLM_v4_qwen_7b_all_test_0113/eval_step_3000.jsonl
