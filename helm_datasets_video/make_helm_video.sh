...
OUT_ROOT="/data/ghkim/helm_data/helm_video_task_3"
...
python helm_datasets_video/merge_helm_video_data.py \
  --src_root "/data/ghkim/helm_data/helm_video_task_3/jsonl_v4" \
  --dst_root "/data/ghkim/helm_data/helm_video_task_3/merged"